...
//		readPrivateKey("D:\\key\\商户私钥_读取密码12345678.pfx", "12345678");
		readPubliKey("E:\\payease_public.cer");

//		readPrivateKey("E:\\TYC_payease_private.pfx", "A168868");
	...
	public static void readPrivateKey(String strPfx, String strPassword) throws Exception {
		...
		System.out.println("public key = " + RsaUtil.byteArr2HexString(pubkey.getEncoded()));
		System.out.println("private key = " + RsaUtil.byteArr2HexString(prikey.getEncoded()));
	}
	...
	public static void readPubliKey(String path) throws Exception {
		...
		String publicKeyString = RsaUtil.byteArr2HexString(publicKey.getEncoded());
